...
public class QComments extends EntityPathBase<Comments> {
    ...
    private static final long serialVersionUID = -1158638811L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QComments comments = new QComments("comments");

    public final yun.likelion.be_study.entity.boards.QBoards board;
    ...
    public QComments(Class<? extends Comments> type, PathMetadata metadata, PathInits inits) {
        ...
        this.board = inits.isInitialized("board") ? new yun.likelion.be_study.entity.boards.QBoards(forProperty("board"), inits.get("board")) : null;
